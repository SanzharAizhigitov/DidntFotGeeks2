...
import com.geektech.dadsquiz.databinding.FragmentQ7Binding

class Q7Fragment : Fragment() {
    lateinit var binding: FragmentQ7Binding
    lateinit var preferences: MyPreferences
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentQ7Binding.inflate(inflater, container, false)
        return binding.root
    }
