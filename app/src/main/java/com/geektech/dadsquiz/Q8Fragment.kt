...
import com.geektech.dadsquiz.databinding.FragmentQ8Binding

class Q8Fragment : Fragment() {
    lateinit var binding: FragmentQ8Binding
    lateinit var preferences: MyPreferences
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentQ8Binding.inflate(inflater, container, false)
        return binding.root
    }
